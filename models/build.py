...
from .swin_transformer_mtlprompt import PromptedSwinUTransformer
from .swin_u_transformer import MTLSwinUNet
...
def build_model(config, is_pretrain=False):
    ...
    if model_type == 'swin':
        if config.MODEL.MTLORA.ENABLED:
            ...
            model = PromptedSwinUTransformer(cfg=config,
